import Testing
import Foundation
@testable import AestrixBench

@Suite("AestrixBench metrics")
struct MetricsAggregatorTests {
    ...
    func jsonRoundTrip() throws {
        ...
        let tmp = FileManager.default.temporaryDirectory
            .appendingPathComponent("aestrix-bench-test-\(UUID().uuidString).json")
        ...
        func make(_ label: String, e2e: Double, rss: Double) -> BenchReport {
            ...
            return BenchReport(
                ...
                system: SystemSnapshot(
                    ...
                    mlxCacheLimitBytes: nil, mlxMemoryLimitBytes: nil, aestrixGitSha: nil,
