...
Next: the `--dit-engine direct` pipeline seam, the first image generated end-to-end on the bespoke engine (direct TE + direct DiT), judged by the anatomy set at 1024².
