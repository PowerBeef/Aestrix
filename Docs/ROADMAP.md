...
**Last updated:** 2026-08-18 (full-repo **audit + hardening pass** landed, `9ad69cd`: all 22 Critical/High/Medium findings fixed — durable print history, harness quarantine/sweep/param-threading, pipeline cancellation, atomic embed cache, CLI validation, 3-bit retirement, metallib gating, CI widened to 18 suites. Engine state unchanged from 2026-08-16 Tiers 0–2: 512² 23.0 s / 1024² 71.0 s / watermark 3.00 GiB, on-device 11.6 s; Tier 3 partial-pad study is the next engine lever; P7 1024² anatomy still open)  
