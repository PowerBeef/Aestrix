...
**Last updated:** 2026-08-16 ([`ENGINE_RESEARCH.md`](ENGINE_RESEARCH.md) Tiers 0–2 shipped: 512² 23.0 s / 1024² 71.0 s / watermark 3.00 GiB, on-device 11.6 s; Tier 3 partial-pad study is the next engine lever; P7 1024² anatomy still open — in-app I2I on device closed 2026-08-16)  
