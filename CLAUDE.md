...
2. **Default to filtered unit tests and 512² smokes.** 1024² T2I bench is OK when asked (~74 s, watermark 3.46 GiB). Do **not** start a 4-trial `identity-i2i` at 1024 (joint ~8704) unless the user explicitly wants it.
